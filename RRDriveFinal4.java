...
@TeleOp(name = "RRDriveFinal4", group = "Competition")

public class RRDriveFinal4 extends OpMode {
...
//        BrushMotor2.setDirection(DcMotor.Direction.FORWARD); // removed 2nd brush motor from robot
...
//        double turn  = gamepad1.right_stick_x;
        ...
        double phase = -Math.cos(angle * 2);
        double power = (-Math.cos(angle * 2)) / 4 + 0.75;
        double left_dir = Math.signum(gamepad1.right_stick_x * gamepad1.right_stick_y);
...
//        RightPower = Range.clip(drive + turn, -1.0, 1.0) ;
        ...
        LeftPower = left_dir * power;
        RightPower = LeftPower * phase;
