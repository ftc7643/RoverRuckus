...
@TeleOp(name = "RRDriveFinal6", group = "Competition")

public class RRDriveFinal6 extends OpMode {
...
// SERVO AND MOTOR CODE TO MOVE ARM TO POSITION AND HOLD
            ...
            if (gamepad2.dpad_up) {
                ...
                while (runtime.seconds() < 0.5) {
                    telemetry.addData("Path", "Posotion 1: %2.5f S Elapsed", runtime.seconds());
                    telemetry.update();
                }
            }
                if (gamepad2.dpad_down) {
                    ArmServo.setPosition(2.2);
                    ArmMotor.setPower(0.5);
                    runtime.reset();
